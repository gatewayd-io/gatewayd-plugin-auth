PLUGIN_NAME=gatewayd-plugin-auth
...
.PHONY: tidy build build-dev checksum update-all update-direct-deps test test-cover lint create-build-dir build-release build-platform
